...
export class Sampler {
  ...
  public constructor(
    ...
    this.player = new DefaultPlayer(context, this._options);
    const storage = options.storage ?? HttpStorage;
    const loader =
      typeof this._options.buffers === "function"
        ? this._options.buffers
        : createAudioBuffersLoader(this._options.buffers, storage);
