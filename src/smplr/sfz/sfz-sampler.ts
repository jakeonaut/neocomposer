...
export class SfzSampler {
  ...
  start(sample: SampleStart | string | number) {
    this._startLayers(typeof sample === "object" ? sample : { note: sample });
  }
